...
manage(Window w, XWindowAttributes *wa)
{
	...
	updatetitle(c);
	opacity(c, defaultopacity); // defaultopacity
...
setup(void)
{
	...
	netatom[NetWMWindowsOpacity] = XInternAtom(dpy, "_NET_WM_WINDOW_OPACITY", False); // defaultopacity
